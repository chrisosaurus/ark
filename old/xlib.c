...
int main(){
	...
	/* parse the color green and allocate for later use */
	...
	XSetForeground(dpy, pgc, white_color);
	...
	XFillRectangle(dpy, pixmap, pgc, 0, 0, 100, 100);
	XSetForeground(dpy, pgc, black_color);
